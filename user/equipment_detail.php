  ...
  <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <tr>
      <td colspan="2" align="left" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="customers" class="style10">
        ...
        <tr>
          <td height="41" align="center" valign="middle" bordercolor="#CCCCCC"><div class="zoom"><img src="../admin/image/<?=$info[photo];?> "  width="120" /></div></td>
          <td align="center"><a href="../admin/equipment_detail.php?e_id=<?=$info['e_id']?>">
            <?=$info[e_name];?>
