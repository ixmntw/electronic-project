...
if($_GET["txtKeyword"] != "")
 ...
 <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0" class="ex-lgradient3">
   <tr >
     <td height="38" align="center"><h1 class="style11">ข้อมูลอุปกรณ์อิเล็กทรอนิกส์</h1>
     </td>
   </tr>
   <tr>
     <td align="center" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="customers" class="style10">
         <tr class="ex-lgradient">
           ...
           <td width="41%" align="center"> ชื่อ</td>
           <td width="24%" align="center">เลขครุภัณฑ์</td>
           <td width="5%" align="center">จำนวน</td>
           <td width="5%" align="center">ยืม</td>
         </tr>
         <? $i = 1; while($info = mysql_fetch_array( $objQuery )) {  ?>
         <tr>
           <td height="41" align="center" ><?=$i++;?></td>
           <td width="15%" align="center" valign="middle" bordercolor="#CCCCCC"><div class="zoom"><img src="../admin/image/<?=$info[photo];?> "  width="120" /></div></td>
           <td width="41%" align="center"><a href="equipment_detail.php?e_id=<?=$info['e_id']?>">
              <?=$info[e_name];?> </a>
           <input type="hidden" name="e_id[]" value="<?=$info['e_id'];?>" /></td>
           <td align="center"><?=$info[e_detail];?></td>
           <td width="5%" align="center" valign="middle" bordercolor="#CCCCCC"><?  
	...
	echo"$qty";	
	?></td>
           <td width="5%" height="41" align="center" valign="middle" bordercolor="#CCCCCC">
		   <a href="order.php?ProductID=<?php echo $info["e_id"];?>" class="style6">
		    <img src="img/add.gif" width="25" border="0" /></a> </td>
         </tr>
         <? }?>
       </table>       
       <p>&nbsp; </p></td>
